...
const { adminLogin, isAdminAuth, userDetails, eventDetails, communityDetails, userAction, eventAction, communityAction, reportDetails, reportAction, addArticle, articleDetails, articleAction, userCount, reportCount, getArticles, editArticle, articleMetrics } = require("../controllers/adminController")
...
router.get("/articlemetrics",adminAuthentication,articleMetrics)
